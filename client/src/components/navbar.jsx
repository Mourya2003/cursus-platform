    ...
    <Fragment>
      ...
      <header className="h-16 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 shadow-lg flex items-center px-4 md:px-8 sticky top-0 z-20 transition-all duration-300">
        ...
        <div className="flex items-center gap-3 flex-1">
          <img
            src="https://pplx-res.cloudinary.com/image/private/user_uploads/63177784/a9689481-4289-42c9-b4f0-f2b90c9b5827/ct_logo.jpg"
            alt="Cursus Logo"
            className="h-10 w-10 object-contain"
            style={{ minWidth: "40px" }}
          />
          <span
            className="text-4xl font-bold text-white dark:text-yellow-300 tracking-wide"
