...
//                   <a className="nav-item nav-link active" href="/about_us">About</a>
//                   <a className="nav-item nav-link" href="/our_blog">Blog</a>
//                   <a className="nav-item nav-link" href="/company_details">Company</a>
//                   <a className="nav-item nav-link" href="/career">Careers</a>
//                   <a className="nav-item nav-link" href="/press">Press</a>
//                 </div>
//               </nav>
//             </div>
...
//               <a href="#" className="crer_btn_link">Join Our Team</a>
//             </div>
//           </div>
//           <div className="col-lg-6">
//             <div className="jmio125">
