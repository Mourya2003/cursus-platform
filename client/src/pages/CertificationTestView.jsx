...
function CertificationTestView() {
  return (
    <div>
      {/* Header */}
                      ...
                      <div className="channel_my">
                        <div className="profile_link">
                          ...
                          <div className="pd_content">
                            ...
                            <span>
                              <a href="https://gambolthemes.net/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="83e4e2eee1ecefbab7b0c3e4eee2eaefade0ecee">
                                [email&#160;protected]
                              </a>
                            </span>
                          </div>
              ...
              <div className="col-lg-7 col-md-6">
                <div className="certi_form">
                  <div className="all_ques_lest">
                    ...
                    <div className="ques_item">
                      <div className="ques_title">
                        <span>Ques 2 :-</span> what is Wordpress?
                      </div>
